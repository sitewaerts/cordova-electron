...
class SettingJsonParser {
    ...
    configure (config, options, userElectronSettingsPath) {
        ...
        this.package.browserWindow.autoHideMenuBar = config.getPreference('autoHideMenuBar', 'electron') === 'true';
        this.package.removeMenuBar = config.getPreference('removeMenuBar', 'electron') === 'true';

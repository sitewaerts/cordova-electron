...
const support = {
    SigntoolOptions : true, //semver.gte(require('electron-builder/package.json').version, '25.0.0'),
    Capabilities : true, //semver.gte(require('electron-builder/package.json').version, '26.3.6')
}
